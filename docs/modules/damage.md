...
| **Who did the work (records)** | Mohammad Askari (UCLA) (CHEERsafe); Christopher Alegbeleye (MMH); Daniel (low-rise multifamily concept); UF (Prevatt, Agdas) testing and sensitivity analysis |
...
!!! warning "Open item <span class="todo">to be confirmed</span>"
    Version log covering the fixes and UF changes; fill the lookup-table tab; fix the duplicate ID 'LM1'; settle licensing; note that the precipitation term p in the slide's notation is not yet in the model. **Who:** Mohammad Askari (UCLA); Christopher Alegbeleye; Duzgun Agdas
