# kf* management procedures

*Prepared by Caroline Williams; last updated May 6, 2024. Maintained by the kf\* manager; see [Governance](../governance.md).*
...
* Reply with the following email:
  * Thank you for sending your GitHub username. You have been added to the CHEER GitHub. Please follow the [CHEER Hub GitHub Procedures](github.md) for directions on how to use the CHEER GitHub space.
...
* Other products with a DOI
  * Make sure all CHEER outputs are cataloged accoriding to the [CHEER Hub Zotero Cataloging procedures](cataloging.md)
* Any published product should be documented on the CHEER Zotero according to the [CHEER Hub Zotero Cataloging procedures](cataloging.md)


## 5. Ongoing kf* management tasks and calendar
...
!!! warning "Open items noted by the original author <span class="todo">to be confirmed</span>"
    - Add details to sections about github and data cataloging, as needed


| When | Task | Where |
|---|---|---|
| Every December to January | Request the next year's HPC allocation on TACC for CHEER | TACC portal; instructions in the linked Google Doc (login required) |
| Every January | Submit the DesignSafe dataset-award application | designsafe-ci.org/community/dataset-awards |
| Continuous | Review datasets and code before publication; keep the Knowledge Object Inventory current | See [Cataloging](cataloging.md) |
| Every two weeks | kf* meeting: versions created since the last meeting; open inventory rows | |

*Roles rather than names: "you" on this page is the kf\* manager. The person holding the role is listed on the
[Governance](../governance.md) page.* <span class="todo">to be confirmed</span>
