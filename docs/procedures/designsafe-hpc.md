...
<li>Make sure you’ve been added to the CHEER DesignSafe HPC allocation</li>
  ...
  `<p align="center">`
  <img align="center" src="../assets/media05c-DesignSafe_HPCDashboard.png" width="600px" alt="A screenshot of the dashboard layout on the TACC website.">
  </p>
    <ol>
...
<li>Open SSH client (differs for Windows and Mac)</li>
  ...
  `<p align="center">`
  <img align="center" src="../assets/media05c-CHEER_DesignSafe_HPCTerminal.png" width="600px" alt="A screenshot of the terminal interface after logging into Frontera.">
  </p>
