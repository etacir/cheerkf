...
<img align="right" src="../../assets/media/05a-TACC_umbrella.png" width="210px" alt="TACC's logo is overarching above a vertical DesignSafe logo with other vertical text marked other under the TACC logo">
...
* [CHEER Hub Top Ten Data Tips](data-tips.md)
* [CHEER Hub DesignSafe Data Upload Procedures](designsafe-data-upload.md
