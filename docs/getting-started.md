...
2. **Set up an environment.** Python 3.11 or later; each repository lists its own requirements. *(Mohammad Askari)*
...
5. **Run CHEERsafe** on the inventory for one scenario. *(Mohammad Askari)*
